...
// 🎯 THÊM IMPORT FIREBASE MESSAGING VÀ THỐNG KÊ (TỪ XUÂN)
import 'package:firebase_messaging/firebase_messaging.dart';
import '../../../../shared_widgets/user_stats_card.dart';

// 🎯 IMPORT CHATBOT VÀ ĐỔI MẬT KHẨU (TỪ BẠN)
...
class _SenderProfileScreenState extends State<SenderProfileScreen> {
  ...
  // 🌟 CÁC BIẾN QUẢN LÝ DỮ LIỆU THẬT CHO THẺ THỐNG KÊ (TỪ XUÂN)
      ...
      if (currentUserId != null) {
        ...
        if (mounted) {
          setState(() {
            ...
            // 🎯 LẤY DỮ LIỆU THẬT TỪ DATABASE ĐỔ VÀO BIẾN (TỪ XUÂN)
            if (profile != null) {
          ...
          // =========================================================
          // 🎯 KIỂM TRA HẠNG (TIER) ĐỂ ĐĂNG KÝ KHÁCH VIP NHẬN THÔNG BÁO (TỪ XUÂN)
          // =========================================================
          try {
            if (profile != null && profile.tier == 'DIAMOND') {
              ...
              debugPrint(
                "💎 Đã đăng ký DIAMOND_SENDERS thành công tại Profile",
              );
            }
          } catch (e) {
          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  // =========================================================
                  // 🎯 THẺ THỐNG KÊ (RANK, ĐIỂM) (TỪ XUÂN)
                  // =========================================================
                  UserStatsCard(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildMenuCard([
                          ...
                          const Divider(height: 1, indent: 56),
                          // =========================================================
                          // 🎯 NÚT TRUNG TÂM TRỢ GIÚP - CHATBOT (TỪ BẠN)
                          // =========================================================
                          _buildMenuItem(
                            Icons.help_outline,
                            "Trung tâm trợ giúp",
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              // =========================================================
                              // 🎯 HỦY TOÀN BỘ ĐĂNG KÝ TOPIC FIREBASE KHI ĐĂNG XUẤT (TỪ XUÂN)
                              // =========================================================
                              try {
                                await FirebaseMessaging.instance
                                    .unsubscribeFromTopic('ALL_SENDERS');
                                await FirebaseMessaging.instance
                                    .unsubscribeFromTopic('DIAMOND_SENDERS');
                                await FirebaseMessaging.instance
                                    .unsubscribeFromTopic('ALL_DRIVERS');
                                debugPrint(
                                  "🗑️ Đã hủy toàn bộ đăng ký Topic Firebase",
                                );
                              } catch (e) {
