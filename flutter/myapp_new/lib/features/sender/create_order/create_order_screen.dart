...
class _CreateOrderScreenState extends State<CreateOrderScreen> {
  ...
  // --- 3. BIẾN LƯU LOẠI XE (TỪ FILE CỦA BẠN BỒ) ---
  ...
  // --- 4. QUẢN LÝ TRẠNG THÁI VOUCHER VÀ GIÁ TIỀN (TỪ XUÂN) ---
  Map<String, dynamic>? _selectedVoucher; 
  final double _baseShippingFee = 50000.0; // Phí vận chuyển gốc mặc định

  // --- 5. TRẠNG THÁI HỆ THỐNG BIẾN TOÀN CỤC ---
  File? _selectedImage;
                      ...
                      : Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              rawDate = rawDate.replaceAll(" T", "T"); 
  ...
  // 🚀 HÀM ĐÓNG GÓI TẠO ĐƠN VÀ CHUYỂN VNPay (GỘP CẢ LOẠI XE + VOUCHER)
  Future<void> _handleCreateOrder() async {
    ...
    try {
      ...
      // 🎯 CHÈN LOẠI XE ĐÃ CHỌN LÊN BACKEND (TỪ BẠN BỒ)
      ...
      // 🎯 CHÈN MÃ VOUCHER ĐÃ CHỌN LÊN BACKEND (TỪ XUÂN)
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ====== KHỐI CHỌN LOẠI XE (GỘP TỪ BẠN BỒ) ======
  ...
  // 🌟 WIDGET CHỌN LOẠI XE (GỘP TỪ BẠN BỒ)
