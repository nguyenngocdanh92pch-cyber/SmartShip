...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    if (selectedRole == 'DRIVER') {
      if (_makeController.text.trim().isEmpty || _plateController.text.trim().isEmpty) {
                ...
                children: [
                  Expanded(
                    child: _buildUploadButton(
                      "Tải ảnh CCCD\n(Mặt trước)",
                      _cccdImage,
                      () => _showImageSourceSelection(true), // Gọi Menu chọn nguồn ảnh
                    ),
                  ),
                  ...
                  Expanded(
                    child: _buildUploadButton(
                      "Tải ảnh Bằng lái\nxe",
                      _licenseImage,
                      () => _showImageSourceSelection(false), // Gọi Menu chọn nguồn ảnh
                    ),
                  ),
                ],
              ),
