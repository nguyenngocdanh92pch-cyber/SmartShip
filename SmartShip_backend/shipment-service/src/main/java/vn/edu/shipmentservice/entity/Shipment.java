...
public class Shipment {
    ...
    private String appliedVoucherCode; // Lưu mã voucher đã được áp dụng

    // 🎯 LƯU LỊCH SỬ THANH TOÁN VNPAY
    @Column(name = "paid_at")
    private LocalDateTime paidAt; // Ngày giờ khách thanh toán xong

    @Column(name = "transaction_no")
    private String transactionNo; // Mã giao dịch của VNPay trả về để Admin đối soát
}
